          ...
          {(loaded) => (
            <article>
              <Show when={loaded().lang !== loaded().requestedLang}>
                 ...
                 *
                 * This says the same thing in all four languages on purpose.
                 * English and Spanish are not a lesser tier that will never be
                 * filled — nothing stops an author writing in them — so a
                 * Spanish reader is looking at the same kind of gap a Creole
                 * reader is, and gets the same sentence.
                 */}
